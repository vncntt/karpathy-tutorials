...
# hyperparameters
batch_size = 32 #how many examples to process together at once
...
def get_batch(split):
    ...
    ix = torch.randint(len(data)-block_size,(batch_size,)) #the (block_size,) at the end specifies the number of indicies you want
